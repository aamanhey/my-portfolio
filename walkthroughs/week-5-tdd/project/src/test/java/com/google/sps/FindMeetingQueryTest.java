...
public final class FindMeetingQueryTest {
  ...
  public void everyAttendeeIsConsideredPersonCAllDay() {
    // optional attendee C who has an all-day event. The same three time slots should be returned as
    // when C was not invited
    // Have each person have different events. We should see two options because each person has
    // split the restricted times.
    //
    // Events  :       |--A--|     |--B--|
  ...
  public void justEnoughRoomPersonB() {
    ...
    // should be ignored since considering their schedule would result in a time slot smaller than
    // the requested time.
    //
    // Events  : |--A--|     |----A----|
    //                 |-B-|
  ...
  public void justOptionalAttendees() {
    // two optional attendees with several gaps in their schedules. Those gaps should be identified
    // and returned.
    //
    // Events  :       |--A--|     |--B--|     |--A--|   |---B---|     |--A--|
    // Day     : |-----------------------------------------------------------|

...
public final class FindMeetingQuery {
  public Collection<TimeRange> query(Collection<Event> events, MeetingRequest request) {
    ...
    for (Event event : mandatoryEvents) {
      ...
      freeSlots = removesSlotBelowThreshold(freeSlots, request.getDuration());
    }
    ...
    for (Event event : optionalEvents) {
      ...
      optionalFreeSlots = removesSlotBelowThreshold(optionalFreeSlots, request.getDuration());
    }
  ...
  private ArrayList<TimeRange> removesSlotBelowThreshold(
      ArrayList<TimeRange> freeSlots, long duration) {
